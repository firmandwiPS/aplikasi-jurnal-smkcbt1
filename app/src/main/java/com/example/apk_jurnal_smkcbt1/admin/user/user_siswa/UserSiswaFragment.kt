...
class UserSiswaFragment : Fragment() {
    ...
    private val urlTampil = "http://192.168.1.13/backend-app-jurnalcbt1/admin_user/data_user/user_siswa/tampil_data_user_siswa.php"
    private val urlTambah = "http://192.168.1.13/backend-app-jurnalcbt1/admin_user/data_user/user_siswa/tambah_data_user_siswa.php"
    private val urlUbah = "http://192.168.1.13/backend-app-jurnalcbt1/admin_user/data_user/user_siswa/ubah_data_user_siswa.php"
    private val urlHapus = "http://192.168.1.13/backend-app-jurnalcbt1/admin_user/data_user/user_siswa/hapus_data_user_siswa.php"
